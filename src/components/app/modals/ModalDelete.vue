<template>
  <div class="modal">
    ...
    <div class="modal__content modal__delete">
      <div class="modal__body">
            <div class="modal__delete-image">
              <v-svg id="delete-img" width="200" height="200"/>
            </div>
            <div class="modal__delete-content text-h3 text-gray3">
